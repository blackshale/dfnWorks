...
cmd = os.environ['LAGRIT_EXE'] + ' < /home/bjung/github/dfnworks-main/examples/ReservoirExample/CreateWellZone.lgi '
...
os.chdir(DFN.jobname)
cmd = 'python /home/bjung/github/dfnworks-main/examples/ReservoirExample/create_boundaries.py'
subprocess.call(cmd,shell=True)
